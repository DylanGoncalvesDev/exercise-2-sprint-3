<?php
/*tienes la siguiente definición de clase que pretende modelar 
al famoso personaje de Tigger de los libros "Winnie The Pooh" de A A. Milne:*/
...
/* * Define el método getInstance ()que carezca de argumentos. 
     Esta función es responsable de crear una instancia de la clase Tigger 
     sólo una vez y devolver esta única instancia cada vez que se llama.*/
